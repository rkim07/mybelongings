...
export class FileUploadController {
     ...
     *         - name: file
     *           in: path
     *           description: The file associated to the download.
     *           type: string
     *           required: true
     *       responses:
     *         200:
    ...
    public async downloadFile(
        ...
        try {
            const [ filePath, extension ] = await this.fileUploadService.setFilePath(file, host);

            res.contentType(`application/${extension}`);
