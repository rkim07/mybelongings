...
describe("Pipeline Transformations", function () {
  ...
  describe("The sort() method", function () {
    describe("when the value is not an array", function () {
      it("should return the value without any change", function () {
        source = { "foo": "bar" };
        mapper = (0, _lib2.default)();

        mapper.map("foo").sort();

        (0, _code.expect)(mapper.execute(source)).to.equal(source);
      });
    });

    describe("when the value is an array but no comparer is provided", function () {
      it("should return the sorted value", function () {
        source = { "foo": ["war", "bar"] };
        ...
        (0, _code.expect)(mapper.execute(source)).to.equal(expected);
      });
    });

    describe("when the value is an array and a comparer is provided", function () {
      it("should return the sorted value", function () {
        source = {
          "foo": [{
            "x": 4
        ...
        mapper.map("foo").sort(function (item) {
          return item.x;
        });
  ...
  describe("The reverseSort() method", function () {
    describe("when the value is not an array", function () {
      it("should return the value without any change", function () {
        source = { "foo": "bar" };
        mapper = (0, _lib2.default)();

        mapper.map("foo").reverseSort();
    ...
    describe("when the value is an array and a comparer is provided", function () {
      it("should return the sorted value", function () {
        ...
        mapper.map("foo").reverseSort(function (item) {
          return item.x;
        });
