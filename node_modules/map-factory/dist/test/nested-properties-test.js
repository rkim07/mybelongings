...
var labels = ["properties", "nested", "mix of available and missing data"];
var mappings = [{ from: "propertySpaces.parentCategory", to: "property.category" }, { from: "propertySpaces.size", to: "property.size" }];
var source = {
  "propertySpaces": {
