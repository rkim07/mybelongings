...
function merge(range1, range2, output, comp) {
    ...
    return base.merge(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), factory_1.end(range2), output, comp);
}
exports.merge = merge;
/**
...
function inplace_merge(range, middle, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.inplace_merge(factory_1.begin(range), middle, factory_1.end(range), comp);
}
...
function includes(range1, range2, comp) {
    ...
    if (global_1.size(range1) < global_1.size(range2))
        ...
        return base.includes(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), factory_1.end(range2), comp);
}
...
function set_union(range1, range2, output, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.set_union(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), factory_1.end(range2), output, comp);
}
...
function set_intersection(range1, range2, output, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.set_intersection(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), factory_1.end(range2), output, comp);
}
...
function set_difference(range1, range2, output, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.set_difference(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), factory_1.end(range2), output, comp);
}
...
function set_symmetric_difference(range1, range2, output, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.set_symmetric_difference(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), factory_1.end(range2), output, comp);
}
