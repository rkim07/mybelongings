...
function for_each(range, fn) {
    return base.for_each(factory_1.begin(range), factory_1.end(range), fn);
}
...
function for_each_n(range, n, fn) {
    return base.for_each_n(factory_1.begin(range), n, fn);
}
...
function all_of(range, pred) {
    return base.all_of(factory_1.begin(range), factory_1.end(range), pred);
}
...
function any_of(range, pred) {
    return base.any_of(factory_1.begin(range), factory_1.end(range), pred);
}
...
function none_of(range, pred) {
    return base.none_of(factory_1.begin(range), factory_1.end(range), pred);
}
exports.none_of = none_of;
function equal(range1, range2, pred) {
    if (pred === void 0) { pred = comparators_1.equal_to; }
    if (global_1.size(range1) !== global_1.size(range2))
        return false;
    else
        return base.equal(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), pred);
}
exports.equal = equal;
/**
...
function lexicographical_compare(range1, range2, comp) {
    ...
    return base.lexicographical_compare(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), factory_1.end(range2), comp);
}
...
function find(range, val) {
    return base.find(factory_1.begin(range), factory_1.end(range), val);
}
exports.find = find;
/**
...
function find_if(range, pred) {
    return base.find_if(factory_1.begin(range), factory_1.end(range), pred);
}
...
function find_if_not(range, pred) {
    return base.find_if_not(factory_1.begin(range), factory_1.end(range), pred);
}
exports.find_if_not = find_if_not;
function find_end(range1, range2, pred) {
    if (pred === void 0) { pred = comparators_1.equal_to; }
    return base.find_end(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), factory_1.end(range2), pred);
}
exports.find_end = find_end;
function find_first_of(range1, range2, pred) {
    if (pred === void 0) { pred = comparators_1.equal_to; }
    return base.find_first_of(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), factory_1.end(range2), pred);
}
...
function adjacent_find(range, pred) {
    if (pred === void 0) { pred = comparators_1.equal_to; }
    return base.adjacent_find(factory_1.begin(range), factory_1.end(range), pred);
}
exports.adjacent_find = adjacent_find;
function search(range1, range2, pred) {
    if (pred === void 0) { pred = comparators_1.equal_to; }
    return base.search(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), factory_1.end(range2), pred);
}
...
function search_n(range, count, val, pred) {
    if (pred === void 0) { pred = comparators_1.equal_to; }
    return base.search_n(factory_1.begin(range), factory_1.end(range), count, val, pred);
}
exports.search_n = search_n;
function mismatch(range1, range2, pred) {
    if (pred === void 0) { pred = comparators_1.equal_to; }
    if (global_1.size(range1) === global_1.size(range2))
        return base.mismatch(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), pred);
    var limit = Math.min(global_1.size(range1), global_1.size(range2));
    var x = factory_1.begin(range1);
    var y = factory_1.begin(range2);
...
function count(range, val) {
    return base.count(factory_1.begin(range), factory_1.end(range), val);
}
exports.count = count;
/**
...
function count_if(range, pred) {
    return base.count_if(factory_1.begin(range), factory_1.end(range), pred);
}
