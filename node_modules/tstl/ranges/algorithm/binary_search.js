...
function lower_bound(range, val, comp) {
    ...
    return base.lower_bound(factory_1.begin(range), factory_1.end(range), val, comp);
}
...
function upper_bound(range, val, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.upper_bound(factory_1.begin(range), factory_1.end(range), val, comp);
}
...
function equal_range(range, val, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.equal_range(factory_1.begin(range), factory_1.end(range), val, comp);
}
...
function binary_search(range, val, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.binary_search(factory_1.begin(range), factory_1.end(range), val, comp);
}
