...
function min_element(range, comp) {
    ...
    return base.min_element(factory_1.begin(range), factory_1.end(range), comp);
}
...
function max_element(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.max_element(factory_1.begin(range), factory_1.end(range), comp);
}
...
function minmax_element(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.minmax_element(factory_1.begin(range), factory_1.end(range), comp);
}
...
function is_permutation(range1, range2, pred) {
    ...
    if (global_1.size(range1) !== global_1.size(range2))
        ...
        return base.is_permutation(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2), pred);
}
...
function prev_permutation(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.prev_permutation(factory_1.begin(range), factory_1.end(range), comp);
}
...
function next_permutation(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.next_permutation(factory_1.begin(range), factory_1.end(range), comp);
}
