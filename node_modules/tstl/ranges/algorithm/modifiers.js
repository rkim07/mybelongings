...
function copy(range, output) {
    return base.copy(factory_1.begin(range), factory_1.end(range), output);
}
exports.copy = copy;
/**
 * Copy *n* elements.
...
function copy_n(range, n, output) {
    return base.copy_n(factory_1.begin(range), n, output);
}
...
function copy_if(range, output, pred) {
    return base.copy_if(factory_1.begin(range), factory_1.end(range), output, pred);
}
...
function copy_backward(range, output) {
    return base.copy_backward(factory_1.begin(range), factory_1.end(range), output);
}
...
function fill(range, value) {
    return base.fill(factory_1.begin(range), factory_1.end(range), value);
}
exports.fill = fill;
/**
 * Fill *n* elements.
...
function fill_n(range, n, value) {
    return base.fill_n(factory_1.begin(range), n, value);
}
...
function transform(range1) {
    ...
    var fn = base.transform.bind(undefined, factory_1.begin(range1), factory_1.end(range1));
    if (args.length === 3)
        return fn.apply(void 0, __spread(args));
    else // args: #4
        return fn(factory_1.end(args[1]), args[2], args[3]);
}
...
function generate(range, gen) {
    return base.generate(factory_1.begin(range), factory_1.end(range), gen);
}
...
function generate_n(range, n, gen) {
    return base.generate_n(factory_1.begin(range), n, gen);
}
...
function unique(range, pred) {
    ...
    return base.unique(factory_1.begin(range), factory_1.end(range), pred);
}
...
function unique_copy(range, output, pred) {
    if (pred === void 0) { pred = comparators_1.equal_to; }
    return base.unique_copy(factory_1.begin(range), factory_1.end(range), output, pred);
}
...
function remove(range, val) {
    return base.remove(factory_1.begin(range), factory_1.end(range), val);
}
...
function remove_if(range, pred) {
    return base.remove_if(factory_1.begin(range), factory_1.end(range), pred);
}
...
function remove_copy(range, output, val) {
    return base.remove_copy(factory_1.begin(range), factory_1.end(range), output, val);
}
...
function remove_copy_if(range, output, pred) {
    return base.remove_copy_if(factory_1.begin(range), factory_1.end(range), output, pred);
}
...
function replace(range, old_val, new_val) {
    return base.replace(factory_1.begin(range), factory_1.end(range), old_val, new_val);
}
...
function replace_if(range, pred, new_val) {
    return base.replace_if(factory_1.begin(range), factory_1.end(range), pred, new_val);
}
...
function replace_copy(range, output, old_val, new_val) {
    return base.replace_copy(factory_1.begin(range), factory_1.end(range), output, old_val, new_val);
}
...
function replace_copy_if(range, output, pred, new_val) {
    return base.replace_copy_if(factory_1.begin(range), factory_1.end(range), output, pred, new_val);
}
...
function swap_ranges(range1, range2) {
    return base.swap_ranges(factory_1.begin(range1), factory_1.end(range1), factory_1.begin(range2));
}
...
function reverse(range) {
    return base.reverse(factory_1.begin(range), factory_1.end(range));
}
...
function reverse_copy(range, output) {
    return base.reverse_copy(factory_1.begin(range), factory_1.end(range), output);
}
exports.reverse_copy = reverse_copy;
function shift_left(range, n) {
    return base.shift_left(factory_1.begin(range), factory_1.end(range), n);
}
exports.shift_left = shift_left;
function shift_right(range, n) {
    return base.shift_right(factory_1.begin(range), factory_1.end(range), n);
}
...
function rotate(range, middle) {
    return base.rotate(factory_1.begin(range), middle, factory_1.end(range));
}
...
function rotate_copy(range, middle, output) {
    return base.rotate_copy(factory_1.begin(range), middle, factory_1.end(range), output);
}
...
function shuffle(range) {
    return base.shuffle(factory_1.begin(range), factory_1.end(range));
}
