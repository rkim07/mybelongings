...
function sort(range, comp) {
    ...
    return base.sort(factory_1.begin(range), factory_1.end(range), comp);
}
exports.sort = sort;
/**
...
function stable_sort(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.stable_sort(factory_1.begin(range), factory_1.end(range), comp);
}
...
function partial_sort(range, middle, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.partial_sort(factory_1.begin(range), middle, factory_1.end(range), comp);
}
...
function partial_sort_copy(range, output, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.partial_sort_copy(factory_1.begin(range), factory_1.end(range), factory_1.begin(output), factory_1.end(output), comp);
}
...
function nth_element(range, nth, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.nth_element(factory_1.begin(range), nth, factory_1.end(range), comp);
}
...
function is_sorted(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.is_sorted(factory_1.begin(range), factory_1.end(range), comp);
}
...
function is_sorted_until(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.is_sorted_until(factory_1.begin(range), factory_1.end(range), comp);
}
