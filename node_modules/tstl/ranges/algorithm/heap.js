...
function make_heap(range, comp) {
    ...
    return base.make_heap(factory_1.begin(range), factory_1.end(range), comp);
}
...
function push_heap(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.push_heap(factory_1.begin(range), factory_1.end(range), comp);
}
...
function pop_heap(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.pop_heap(factory_1.begin(range), factory_1.end(range), comp);
}
...
function is_heap(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.is_heap(factory_1.begin(range), factory_1.end(range), comp);
}
...
function is_heap_until(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.is_heap_until(factory_1.begin(range), factory_1.end(range), comp);
}
...
function sort_heap(range, comp) {
    if (comp === void 0) { comp = comparators_1.less; }
    return base.sort_heap(factory_1.begin(range), factory_1.end(range), comp);
}
