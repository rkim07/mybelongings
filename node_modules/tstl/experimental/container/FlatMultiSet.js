...
var FlatMultiSet = /** @class */ (function (_super) {
    ...
    function FlatMultiSet() {
        ...
        // OVERLOADINGS
        ITreeContainer_1.ITreeContainer.construct.apply(ITreeContainer_1.ITreeContainer, __spread([_this, FlatMultiSet, function (comp) {
    ...
    FlatMultiSet.prototype.lower_bound = function (key) {
        return binary_search_1.lower_bound(this.begin(), this.end(), key, this.value_comp());
    };
    /**
     * @inheritDoc
     */
    FlatMultiSet.prototype.upper_bound = function (key) {
        return binary_search_1.upper_bound(this.begin(), this.end(), key, this.value_comp());
    };
    /* ---------------------------------------------------------
        POST-PROCESS
    --------------------------------------------------------- */
