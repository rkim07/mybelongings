...
var FlatMultiMap = /** @class */ (function (_super) {
    ...
    function FlatMultiMap() {
        ...
        // OVERLOADINGS
        ITreeContainer_1.ITreeContainer.construct.apply(ITreeContainer_1.ITreeContainer, __spread([_this, FlatMultiMap, function (comp) {
    ...
    FlatMultiMap.prototype.lower_bound = function (key) {
        return binary_search_1.lower_bound(this.begin(), this.end(), this._Capsule_key(key), this.value_comp());
    };
    /**
     * @inheritDoc
     */
    FlatMultiMap.prototype.upper_bound = function (key) {
        return binary_search_1.upper_bound(this.begin(), this.end(), this._Capsule_key(key), this.value_comp());
    };
