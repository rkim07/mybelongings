...
var ArrayContainer = /** @class */ (function (_super) {
    ...
    ArrayContainer.prototype.erase = function (first, last) {
        ...
        if (first._Get_array() !== this || last._Get_array() !== this)
            ...
            throw new RangeError_1.RangeError("Error on " + ErrorGenerator_1.ErrorGenerator.get_class_name(this.source()) + ".erase(): first iterator has greater index than last -> (first = " + first.index() + ", last = " + last.index() + ").");
        // ADJUSTMENT
