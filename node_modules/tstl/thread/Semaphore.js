    ...
    Semaphore.prototype.release = function (n) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                //----
                if (n < 1)
                    throw new InvalidArgument_1.InvalidArgument("Error on std.Semaphore.release(): parametric n is less than 1 -> (n = " + n + ").");
                else if (n > this.max_)
                    throw new OutOfRange_1.OutOfRange("Error on std.Semaphore.release(): parametric n is greater than max -> (n = " + n + ", max = " + this.max_ + ").");
                else if (n > this.acquiring_)
                    throw new OutOfRange_1.OutOfRange("Error on std.Semaphore.release(): parametric n is greater than acquiring -> (n = " + n + ", acquiring = " + this.acquiring_ + ").");
                resolverList = [];
