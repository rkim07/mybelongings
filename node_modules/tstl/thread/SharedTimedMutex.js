...
var SharedTimedMutex = /** @class */ (function () {
    ...
    SharedTimedMutex.prototype.unlock = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this._Current_access_type() !== 0 /* WRITE */)
                    throw new InvalidArgument_1.InvalidArgument("Error on std." + this.source_.constructor.name + ".unlock(): this mutex is free on the unique lock.");
                --this.writing_;
    ...
    SharedTimedMutex.prototype.unlock_shared = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this._Current_access_type() !== 1 /* READ */)
                    throw new InvalidArgument_1.InvalidArgument("Error on std." + this.source_.constructor.name + ".unlock_shared(): this mutex is free on the shared lock.");
                --this.reading_;
                this.queue_.pop_front();
                this._Release();
                return [2 /*return*/];
    ...
    SharedTimedMutex.prototype._Release = function () {
        ...
        try {
            for (var _c = __values(this.queue_), _d = _c.next(); !_d.done; _d = _c.next()) {
                ...
                if (resolver.accessType === 0 /* WRITE */)
                    break;
            }
        }
